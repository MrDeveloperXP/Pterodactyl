...
Route::group(['prefix' => 'plans'], function () {
    ...
    Route::get('/view/{plan}', [Admin\PlanController::class, 'view'])->name('admin.plans.view');
    Route::post('/', [Admin\PlanController::class, 'store']);
    Route::patch('/view/{plan}', [Admin\PlanController::class, 'update']);
});
...
Route::group(['prefix' => 'currencies'], function () {
    Route::get('/', [Admin\CurrencyController::class, 'index'])->name('admin.currencies');
    Route::post('/', [Admin\CurrencyController::class, 'store']);
    Route::patch('/{currency}', [Admin\CurrencyController::class, 'update'])->name('admin.currencies.update');
});
...
|--------------------------------------------------------------------------
|
| Endpoint: /admin/resource-prices
|
*/
Route::group(['prefix' => 'resource-prices'], function () {
    Route::get('/', [Admin\ResourcePriceController::class, 'index'])->name('admin.resource-prices');
    Route::post('/', [Admin\ResourcePriceController::class, 'store']);
    Route::patch('/{resourcePrice}', [Admin\ResourcePriceController::class, 'update'])->name('admin.resource-prices.update');
});
